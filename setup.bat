...
if "!ANTHROPIC_API_KEY!"=="" (
  echo [FATAL] ANTHROPIC_API_KEY 未设置
  pause
  exit /b 3
)
if "!ANTHROPIC_MODEL!"=="" (
...
echo [INFO] 隔离模式:     DISABLE_AUTOUPDATER=!DISABLE_AUTOUPDATER!  CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC=!CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC!
echo.
